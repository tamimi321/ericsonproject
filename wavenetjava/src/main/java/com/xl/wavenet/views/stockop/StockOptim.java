package com.xl.wavenet.views.stockop;
...
@PageTitle("Stock Optimization")
@Route("stockoptim")
@Menu(order = 2, icon = LineAwesomeIconUrl.GLOBE_SOLID)
public class StockOptim extends HorizontalLayout {
	...
	public StockOptim() {
		...
		IFrame frame = new IFrame(
				"https://app.powerbi.com/reportEmbed?reportId=c959fdee-3207-46de-90a8-526d07ef86ac&autoAuth=true&ctid=a1eae0da-f0d1-449d-8854-f54ddbda8711&navContentPaneEnabled=false");
